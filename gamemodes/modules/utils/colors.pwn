stock ColorLighten(colour, Float:Amount = 0.3)
{
    new a = colour & 0xFF;
...
stock ColorDarken(colour, Float:Amount = 0.3)
{
    new a = colour & 0xFF;
...
#define GetColorShade(%0,%1)\
 		format(%1, sizeof %1, "%06x", (0xFFFFFFFF & (%0)))

#define CRVENA 						0xFF0000FF
#define SVETLOCRVENA   				0xFF6347FF
#define SVETLOCRVENA2               0xFF8282FF
#define TAMNOCRVENA         		0x880000FF
#define TAMNOCRVENA2         		0xDC143CFF
#define ZUTA 						0xFFFF00FF
#define ZUTA2                   	0xF5DEB3FF
#define SVETLOZUTA          		0xFFFF80FF
#define NARANDZASTA 				0xFF9900FF
...
#define ZELENOZUTA              	0x8EFF00FF
#define CRNA 						0x00000000
#define GRAD1                       0xB4B5B7FF
#define GRAD2 						0xBFC0C2FF
#define GRAD3                   	0x6A696AFF
#define SVETLOPLAVA 				0x33CCFFFF
#define LJUBICASTA 					0xC2A2DAFF
#define OOCBOJA 					0xE0FFFFFF
#define LTPINK          			0xF7BBEEFF
#define SVETLOLJUBICASTA    		0x8080FFFF
#define TAMNOLJUBICASTA         	0xAC12F4FF
// #define TAMNOCRVENA         		0x880000FF
#define BRAON               		0x884904FF
#define TAMNOPLAVA          		0x2641FEFF
#define RADIO_BOJA              	0x83BFBFFF
#define DEPT_BOJA               	0x9BC9CEFF
#define PLAVAX                  	0x008080FF
#define POSAOBOJA               	0x8080FFFF
#define IVORY                  		0xBE9641FF
#define ZLATNA                  	0xFFFF80FF
#define INFOPLAVA                   0x4655B2FF
#define DEBUG						0x4A9AEAFF // Svetlija: A4CCF2
#define ERROR                       0xE94A4AFF // Svetlija: F1A3A4
#define INFO                        0x5BE181FF // Svetlija: 9DF2B5
#define NARANDZASTA_ORG				0xFBC800FF
#define COLOR_SKILL					0x940025FF
